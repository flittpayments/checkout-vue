...
export const FFee = defineAsyncComponent(
  () => import(/* webpackChunkName: "74" */ '@/components/base/fee')
)

export const MethodClientFee = () =>
  import(
    /* webpackChunkName: "75" */ '@/views/checkout/method/system/client-fee'
  )

export const RowFloating = defineAsyncComponent(
  () =>
    import(
      /* webpackChunkName: "76" */ '@/components/input/helpers/row-floating'
    )
)
...
export const RowNoFloating = defineAsyncComponent(
  () =>
    import(
      /* webpackChunkName: "77" */ '@/components/input/helpers/row-no-floating'
    )
)
